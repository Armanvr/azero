...
export default function CharAvatar({ character, size = 160 }: { character: Character; size?: number }) {
  ...
  return (
    <svg width={size} height={size} viewBox="0 0 160 160">
      ...
      <text x="80" y="76" textAnchor="middle" fill={c1} fontSize="36" fontFamily="Rajdhani" fontWeight="700" opacity="0.7">
        {character.name.slice(0, 2).toUpperCase()}
      </text>
      <text x="80" y="130" textAnchor="middle" fill={c1} fontSize="11" fontFamily="Exo 2" fontWeight="500" opacity="0.5">
