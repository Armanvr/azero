...
export async function GET(req: NextRequest) {
	...
	const charsRes = await fetch('https://eu.api.blizzard.com/profile/user/wow?namespace=profile-eu&locale=fr_FR', {
	...
	if (docs.length > 0) await CharacterModel.insertMany(docs)
